...
void SimpleEQAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
    ...
    //context provides wrapper around block that chain can use
    ...
    SimpleEQAudioProcessor::createParameterLayout()
{
    juce::AudioProcessorValueTreeState::ParameterLayout layout;
        ...
        layout.add(std::make_unique<juce::AudioParameterFloat>("LowCut Freq", // name
                                                               ...
                                                               juce::NormalisableRange<float>(20.f, //low value
                                                                                              20000.f, //high value
                                                                                              1.f, //step size
                                                                                              0.25f), //skew factor
                                                               20.f)); // default value
        ...
        {
            juce::String str;
            str << (12 + i*12); //12 + 0, then 12 + 12 etc
            str << " db/Oct"; //add this phrase to end of last line
            stringArray.add(str);
        }
